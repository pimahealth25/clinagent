...
def llm_summarize(trials: List[Dict[str, Any]], query: str, *, model: str = "gpt-4.1-mini", temperature: float = 0.4) -> str:
...
def refine_query(user_query: str, *, model: str = "gpt-4.1-mini", temperature: float = 0.0) -> Dict[str, Any]:
